...
const NavMenu = () => {
  ...
  <SheetTrigger asChild>
    <Button
      size="icon"
      variant="ghost"
      className="text-gray-200 hover:bg-gray-800 hover:text-white focus:ring-2 focus:ring-purple-500 md:hidden"
    >
  ...
  <SheetContent
    side="right"
    className="w-80 border-none text-gray-200 p-0 bg-gray-950"
  >
    <div className="flex flex-col h-full">
      ...
      <SheetFooter className="border-t border-gray-800">
        <div className="p-6 w-full">
          <Button
            variant="outline"
            className="w-full justify-between border-gray-700 text-white bg-gray-700"
            asChild
          >
            <Link
