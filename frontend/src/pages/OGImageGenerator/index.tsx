      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card className="p-4 sm:p-6">
          <Tabs defaultValue={defaultTab}>
            ...
            <TabsContent value="meta-tags" className="mt-4 overflow-hidden">
              <div className="space-y-4 max-h-[calc(100vh-200px)] overflow-y-auto pr-2">
                ...
                {Object.entries(metaTags).map(([platform, tags]) => (
                  <div className="relative" key={platform}>
                    <h3 className="font-semibold capitalize mb-2 sticky top-12 bg-background z-10 py-2">
                      {platform}
                    </h3>
